...
VulnScan - A Comprehensive Vulnerability Scanning Tool
`
	print(banner)
}
...
func Flag(Info *HostInfo) {
	...
	flag.StringVar(&Info.Host, "h", "", "IP address of the host ,for example: 192.168.11.1")
	flag.StringVar(&Ports, "p", DefaultPorts, "Select a port,for example: 22,80,3306")
